...
import DeckBuilderModal from '../DeckBuilder/DeckBuilderModal';
...
export default function Home() {
    ...
    return (
        <Container maxWidth={false} disableGutters sx={{ py: 0, px: compact ? 1 : 2, height: '100vh', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            {isLoggedIn && <DeckBuilderModal open={deckOpen} onClose={() => setDeckOpen(false)} />}
            ...
            {/* Opening Hand Modal (kept as dialog) */}
            {openingShown && (
